...
def index(request):
    if request.method == 'POST':
        ...
        response = requests.get('http://api.openweathermap.org/data/2.5/weather?q=' + city + '&units=metric&appid=6bc049b14d97f34ee9c5abde29fab429')
        if response.status_code == 200:
            # print(city)
            api_url = urllib.request.urlopen('http://api.openweathermap.org/data/2.5/weather?q=' + city + '&units=metric&appid=6bc049b14d97f34ee9c5abde29fab429').read()
